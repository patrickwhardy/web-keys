var midi, data, cmd, channel, type, note, velocity, messages, osc, analyser;
// request MIDI access
...
function visualize(osc) {
  analyser = context.createAnalyser();
  osc.connect(analyser);
  analyser.fftSize = 2048;
  var bufferLength = analyser.frequencyBinCount;
  var dataArray = new Uint8Array(bufferLength);
  drawVisual(dataArray);
}
...
// if (oscilators.length > 0) {
//   oscilators[0].connect(analyser);
//   console.log(oscilators.length);
// }
